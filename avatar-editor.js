...
var presetsBGs = [
    // head
    'url(\'img/preset-sprite.png\') -355px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -355px -75px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -355px -145px no-repeat #e3cbba',

    // eyes
    'url(\'img/preset-sprite.png\') -145px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -145px -75px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -5px -145px no-repeat #e3cbba',

    // mouth
    'url(\'img/preset-sprite.png\') -355px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -355px -285px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -5px -355px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -75px -355px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -145px -355px no-repeat #e3cbba',

    // hair-front
    'url(\'img/preset-sprite.png\') -285px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -5px -285px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -75px -285px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -145px -285px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -215px -285px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -285px -285px no-repeat #e3cbba',

    // hair-back
    '#e3cbba',
    'url(\'img/preset-sprite.png\') -5px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -215px -145px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -75px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -145px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -215px -215px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -285px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -285px -75px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -285px -145px no-repeat #e3cbba',

    // glasses
    '#e3cbba',
    'url(\'img/preset-sprite.png\') -75px -145px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -145px -145px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -215px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -215px -75px no-repeat #e3cbba',

    // earings
    '#e3cbba',
    'url(\'img/preset-sprite.png\') -5px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -75px -5px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -5px -75px no-repeat #e3cbba',
    'url(\'img/preset-sprite.png\') -75px -75px no-repeat #e3cbba',
];
